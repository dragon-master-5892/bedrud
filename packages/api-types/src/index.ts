...
export const API_ENDPOINTS = {
  ...
  ROOM: {
    ...
    JOIN: '/room/join',
    LIST: '/room/list',
    KICK: (roomId: string, identity: string) => `/room/${roomId}/kick/${identity}`,
    MUTE: (roomId: string, identity: string) => `/room/${roomId}/mute/${identity}`,
    VIDEO_OFF: (roomId: string, identity: string) => `/room/${roomId}/video/${identity}/off`,
    STAGE_BRING: (roomId: string, identity: string) => `/room/${roomId}/stage/${identity}/bring`,
    STAGE_REMOVE: (roomId: string, identity: string) => `/room/${roomId}/stage/${identity}/remove`,
